...
| --- | --- | --- |
| [001 verification baseline](./outdated/plans/001-verification-baseline.md) | Superseded and unexecuted | The completed Phase 0 / June sprint (U1-U3, shipped in PR #20) replaced it. |
...
| [003 auth-gate debug endpoints](./outdated/plans/003-auth-gate-debug-endpoints.md) | Still relevant and promoted | The completed Phase 0 / June sprint made this an explicit U6 go-live decision. Follow the newer plan. |
